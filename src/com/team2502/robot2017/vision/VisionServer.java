...
import com.team2502.robot2017.vision.messages.HeartbeatMessage;
import com.team2502.robot2017.vision.messages.OffWireMessage;
import com.team2502.robot2017.vision.messages.VisionMessage;
...
public class VisionServer implements Runnable {
    ...
    private boolean m_use_java_time = true;
    ...
    public static VisionServer getInstance() {
        if (s_instance == null) {
            s_instance = new VisionServer(RobotMap.Vision.ADB_PORT);
        }
        return s_instance;
    }
     ...
     * 
     * @param port Port to listen to for adb
     */
